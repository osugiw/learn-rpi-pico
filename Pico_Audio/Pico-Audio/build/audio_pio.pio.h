...
#define audio_pio_wrap 7

#define audio_pio_offset_entry_point 7u
...
static inline void audio_pio_program_init(PIO pio, uint sm, uint offset, uint data_pin, uint clock_pin_base) {
    ...
    pio_sm_exec(pio, sm, pio_encode_jmp(offset + audio_pio_offset_entry_point));
}
